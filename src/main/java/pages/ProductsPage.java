...
public class ProductsPage {
    ...
    public CartPage addProductsToCart() {
        TestAutomationHelper.waitForElementToBeClickable(driver, addToCartButton1);
        addToCartButton1.click();
        TestAutomationHelper.waitForElementToBeClickable(driver, continueShoppingButton);
        continueShoppingButton.click();
        TestAutomationHelper.waitForElementToBeClickable(driver, addToCartButton2);
    ...
    public ProductsPage addAllProducts() {
        for (int i = 0; i < addButtons.size(); i = i + 2) {
            TestAutomationHelper.waitForElementToBeClickable(driver, addButtons.get(i));
